                ...
                <div className="welcome-grid-modern">
                    <div className="welcome-content">
                        ...
                        <div className="welcome-stats-modern">
                            <div className="stat-card"><div className="stat-number">{churchInfo ? `${churchInfo.activeMemberCount}+` : ''}</div><div className="stat-label">Active Members</div></div>
                            <div className="stat-card"><div className="stat-number">{churchInfo ? `${churchInfo.yearsOfMinistry}+` : ''}</div><div className="stat-label">Years of Ministry</div></div>
